...
int main(void)
{
    ...
    ConvexHull CH_left{ std::begin(points), std::begin(points) + len };
    ConvexHull CH_mid{ std::begin(points) + len, std::begin(points) + len * 2 };
    ConvexHull CH_right{ std::begin(points) + len * 2, std::end(points) };
